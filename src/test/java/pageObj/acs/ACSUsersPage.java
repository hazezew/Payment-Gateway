...
public class ACSUsersPage {
    ...
    @FindBy(xpath = "//ul/li[.='Foziya']")
    private WebElement roleFoziya;
    @FindBy(xpath = "//ul/li[.='Selam']")
    private WebElement roleSelam;
    ...
    @FindBy(xpath = "//button[@id='addOperatorForm:editOperatorSaveButton']")
    private WebElement saveButton;
    @FindBy(xpath = "//button[@id='operatorsForm:changeOperatorPasswordButton']")
    private WebElement changePasswordButton;

    @FindBy(xpath = "//button[@id='operatorsForm:goBlockOperatorButton']")
    private WebElement addBlockButton;
    @FindBy(xpath = "//input[@id='blockOperatorForm:banStartDatetimeInput_input']")
    private WebElement startDateTime;
    @FindBy(xpath = "//input[@id='blockOperatorForm:banEndDatetimeInput_input']")
    private WebElement endDateTime;
    @FindBy(xpath = "//textarea[@id='blockOperatorForm:banCommentInput']")
    private WebElement comment;
    @FindBy(xpath = "//button[@id='blockOperatorForm:blockOperatorAddButton']")
    private WebElement saveBlockButton;
    @FindBy(xpath = "//div[@id='operatorBansTable']//tbody/tr/td[4]")
    private WebElement reasonForBlockingUser;
    ...
    public void addRoleAdminRole() {
        ...
        this.addSingleRoleIcon.click();
        this.roleFoziya.click();
        this.addSingleRoleIcon.click();
        this.roleSelam.click();
        this.addSingleRoleIcon.click();
    ...
    public void setLoginFilterTextField(String loginName) {
        this.loginFilterTextField.clear();
    ...
    public void clickOnAddBlockButton() {
        this.addBlockButton.click();
    }
    public void setStartDateTime(String startDateTime) {
        this.startDateTime.sendKeys(startDateTime);
    }
    public void setEndDateTime(String endDateTime) {
        this.endDateTime.sendKeys(endDateTime);
    }
    public void setComment(String comment) {
        this.comment.sendKeys(comment);
    }
    public void clickOnSaveBlockButton() {
        this.saveBlockButton.click();
        try {
            Thread.sleep(2000);
        } catch (InterruptedException e) {
            e.printStackTrace();
    ...
    public String getReasonForBlockingUser() {
        return this.reasonForBlockingUser.getText();
    }
}

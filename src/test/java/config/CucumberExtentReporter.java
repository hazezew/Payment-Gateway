...
public class CucumberExtentReporter {
    ...
    public CucumberExtentReporter(){
        ...
        extentHtmlReporter.config().setDocumentTitle("Payment Gateway System Test Automation");
        extentHtmlReporter.config().setReportName("Payment Gateway System Test Automation Report");
